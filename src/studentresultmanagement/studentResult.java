...
public class studentResult extends javax.swing.JFrame {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            ResultSet rs= st.executeQuery("select* from student inner join result where student.rollNum = '"+ rollno + "' and result.rollNum = '"+ rollno + "'");
            if(rs.next()){
                ...
                int s3= Integer.parseInt( jTextField6.getText());
                int s4= Integer.parseInt( jTextField6.getText());
