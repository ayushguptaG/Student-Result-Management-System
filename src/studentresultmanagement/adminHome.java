...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("UPLOAD RESULT");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "IT", "CIVIL", "ECE" }));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        String rollNum= (String)jTextField1.getText();
        ...
        try{
            ...
            st.executeUpdate("insert into student values('"+ course +"','"+ branch +"','"+ rollNum +"','"+ name +"','"+ gender +"','"+ fathersName +"')");
